def detect_model_bias(test_data, y_pred, group_feature, target):
    """
    ...
    - group_feature (str): Feature name to group by (e.g., 'Bldg Type').
    ...
    bldg_types = test_data[group_feature].unique()
    y_true = test_data[target]

    group_metrics = []
    for bldg_type in bldg_types:
        group_indices = test_data[group_feature] == bldg_type
