...
def train_and_predict_linear_regression(augmented_data, test_data, combined_features):
    ...
    run_name = f"LinearRegression_{len(combined_features)}_features_{timestamp}"
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        mlflow.register_model("runs:/{}/model".format(mlflow.active_run().info.run_id), "LinearRegression")
...
def compare_models_linear_regression(train_data, augmented_data, test_data, combined_features):
    """
    ...
    y_pred_original, _ = train_and_predict_linear_regression(train_data, test_data, combined_features)
    ...
    y_pred_augmented, _ = train_and_predict_linear_regression(augmented_data, test_data, combined_features)
